<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SalesStatistics.aspx.vb" Inherits="Client_Statistics" %>
...
<body style="background-color: #f8f2cf">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="50pt" Text="Sales Statistics" Font-Names="Gill Sans MT" ForeColor="#663300"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                    <br />
                </td>
            </tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource1" Height="710px" Width="781px">
                <Series>
                    <asp:Series ChartType="Pie" Legend="Items" Name="Series1" XValueMember="ItemID" YValueMembers="1">
                    </asp:Series>
                </Series>
                <ChartAreas>
                ...
                <Legends>
                    <asp:Legend Name="Items">
                    </asp:Legend>
                </Legends>
            </asp:Chart>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT ItemID, Quantity FROM Sales GROUP BY ItemID, Quantity"></asp:SqlDataSource>
