<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClientMenu.aspx.vb" Inherits="ClientMenu" %>
...
<body style="background-color:#f8f2cf">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="50pt" Text="Client Menu" Font-Names="Gill Sans MT" ForeColor="#663300"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Images/Sub-Menu/AddSuppliers.png" NavigateUrl="~/Clients/AddClient.aspx">HyperLink</asp:HyperLink>
                            </td>
                            <td style="text-align: center">
                    <asp:ImageButton ID="SignUps" runat="server" Height="64px" ImageUrl="~/Images/Sub-Menu/AddClient.png" Width="64px" />
                            </td>
                            <td style="text-align: center">
                    <asp:HyperLink ID="HyperLink3" runat="server" ImageUrl="~/Images/Sub-Menu/List.png" NavigateUrl="~/Clients/ClientList.aspx">HyperLink</asp:HyperLink>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td style="text-align: center">
                    <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Names="Gill Sans MT" ForeColor="#663300" Text="Add a Client"></asp:Label>
                            </td>
                            <td style="text-align: center">
                    <asp:Label ID="Label20" runat="server" Font-Bold="True" Font-Names="Gill Sans MT" ForeColor="#663300" Text="Sign Ups"></asp:Label>
                            </td>
                            <td style="text-align: center">
                    <asp:Label ID="Label19" runat="server" Font-Bold="True" Font-Names="Gill Sans MT" ForeColor="#663300" Text="List of Clients"></asp:Label>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
