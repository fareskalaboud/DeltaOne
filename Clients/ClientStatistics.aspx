<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClientStatistics.aspx.vb" Inherits="ClientStatistics" %>
...
<body style="background-color:#f8f2cf">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="50pt" Text="Client Statistics" Font-Names="Gill Sans MT" ForeColor="#663300"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                    <br />
                </td>
            </tr>
