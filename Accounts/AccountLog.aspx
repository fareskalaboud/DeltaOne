<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AccountLog.aspx.vb" Inherits="Accounts_AccountLog" %>
...
<body style="background-color: #F8F2CF">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="50pt" Text="Account Log" Font-Names="Gill Sans MT" ForeColor="#663300"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
        <tr>
                <td class="auto-style3" style="text-align: left; background-color: #F8F2CF;">
                    ...
                    <br />
                    <br />
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="TransactionID" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="None" Width="916px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="AddTo" HeaderText="AddTo" SortExpression="AddTo" />
                            <asp:BoundField DataField="ReasonAdd" HeaderText="ReasonAdd" SortExpression="ReasonAdd" />
                            <asp:BoundField DataField="DeductFrom" HeaderText="DeductFrom" SortExpression="DeductFrom" />
                            <asp:BoundField DataField="ReasonDeduct" HeaderText="ReasonDeduct" SortExpression="ReasonDeduct" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [AccountBalance]"></asp:SqlDataSource>
                    <br />
                    <br />
                    <br />
                    <br />
