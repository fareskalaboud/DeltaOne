<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PurchaseStatistics.aspx.vb" Inherits="Purchases_PurchaseStatistics" %>
...
<body style="background-color: #f8f2cf">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="50pt" Text="Purchase Statistics" Font-Names="Gill Sans MT" ForeColor="#663300"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                    <br />
                </td>
            </tr>
...
&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            &nbsp;<asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource1" Height="730px" Width="745px">
                <Series>
                    <asp:Series ChartType="Pie" Legend="Items" Name="Series1" XValueMember="ItemID" YValueMembers="Quantity">
                    </asp:Series>
                </Series>
                <ChartAreas>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>" ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT ItemID, Quantity FROM Purchases GROUP BY ItemID, Quantity"></asp:SqlDataSource>
            <br />
            <br />
            <br />
            <br />
