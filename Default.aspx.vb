...
Partial Class Home
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Session("AccessToAccounts") = "False" Then
            ...
            btnMrq.Visible = False
            txtMrq.Visible = False
        End If
        Session.Timeout = 10
    ...
    Protected Sub btnMrq_Click(sender As Object, e As EventArgs) Handles btnMrq.Click
        If txtMrq.Text = "" Then
            ErrorLabel.Text = "Error:You have left the field blank. Please try again."
        Else
            Dim File As String = "G:\Sync\College\Computing\DeltaOne\MarqueeText.txt"
            Dim TextLine As String
            ' Open file.
            FileOpen(1, File, OpenMode.Output)
            ' Read line into variable.
            TextLine = txtMrq.Text
            ' Print text to file.
