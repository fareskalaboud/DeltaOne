<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SupplierStatistics.aspx.vb" Inherits="Client_Statistics" %>
...
<body style="background-color: #f8f2cf">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="50pt" Text="Supplier Statistics" Font-Names="Gill Sans MT" ForeColor="#663300"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                    <br />
                </td>
            </tr>
...
&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:Label ID="Label18" runat="server" Font-Names="Gill Sans MT" Font-Overline="False" Font-Size="X-Large" Font-Underline="True" ForeColor="#663300" Text="Not Yet Implemented"></asp:Label>
